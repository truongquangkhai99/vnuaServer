...
@RestController
@RequestMapping("/api/vnua-server-kafka")
public class VnuaServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(VnuaServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public VnuaServerKafkaResource(KafkaProperties kafkaProperties) {
