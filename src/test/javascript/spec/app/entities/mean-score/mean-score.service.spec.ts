...
describe('Service Tests', () => {
  describe('MeanScore Service', () => {
    let injector: TestBed;
    let service: MeanScoreService;
    let httpMock: HttpTestingController;
    let elemDefault: IMeanScore;
    let expectedResult: IMeanScore | IMeanScore[] | boolean | null;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of MeanScore', () => {
        const returnedFromService = Object.assign(
          {
            diemtbhc10: 1,
            diemtbhc4: 1,
